                ...
                <div className="card">
                  ...
                  <div className="card-body p-4 text-black">
                    ...
                    <div className="d-flex justify-content-between align-items-center mb-4">
                      ...
                      <p className="mb-0"><a href="#!" className="text-muted">{userBlog.length>0?"Show all":""}</a></p>
                    </div>
                    <hr />
                    <div className="row g-2">
                      {userBlog.length>0?userBlog.map((blog)=>{
                        return(
                          <div className="col-12 col-sm-6 mb-2" key={blog._id}>
                            <img src={blog.src} style={{height:"16rem"}} alt="1" className="w-100 rounded-3"/>
                          </div>
                        )
